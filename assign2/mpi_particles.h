...
//TODO
void select_particles(int n, particle_t* particles, particle_t* local, char* p_valid, int* nlocal);
...
//
void receive_immigrants(int* neighbors, particle_t* particles, char* p_valid, int array_sz, int buf_size);
