...
\caption{Serial Microblocks Execution Time for Different Numbers of Particles}
\label{serial_mb_n}
\end{figure}
...
\caption{Floating Point Utilization for Serial Microblocks Code}
...
with the number of particles for the serial sweep and prune algorithm.
...
\caption{Execution Time vs Number of Particles for OpenMP Microblocks}
\label{openmp_mb_n}
\end{figure}
...
\caption{Execution Time vs Number of Processors for OpenMP Microblocks}
\label{openmp_mb_p}
\end{figure}
...
\caption{Floating Point Utilization for OpenMP Microblocks}
...
\caption{Program Time Allocation for OpenMP Microblocks}
...
\caption{Pthreads Sweep and Prune. Time versus Number of Particles.}
\label{plot:thread_t_v_n}
\end{figure}


Figure \ref{plot:thread_speedup_v_p} shows the speed up in terms
of execution time of the threaded sweep and prune code over the serial
...
\caption{Pthreads Sweep and Prune. Speed up over serial versus Number of Processors.}
...
\caption{Pthreads Sweep and Prune. MFlops/second versus Number of Processors.}
...
\caption{Pthreads Sweep and Prune. Breakdown of Execution Time versus Number
of Processors.}
...
\caption{Execution Time vs Number of Particles for MPI Microblocks Code}
\label{mpi_mb_n}
\end{figure}
...
\caption{Execution Time vs Number of Processors for MPI Microblocks Code}
\label{mpi_mb_p}
\end{figure}
...
\caption{Floating Point Utilization for MPI Microblocks Code}
\label{mpi_mb_flops}
\end{figure}
...
\caption{Allocation of Program Time for MPI Microblocks Implementation}
\label{mpi_mb_rtime}
\end{figure}
...
\caption{Processing Time vs Number of Particles for MPI Sweep and Prune}
...
\caption{Floating Point Utilization for MPI Sweep and Prune}
...
\caption{MPI Sweep and Prune Speedup relative to Serial Sweep and Prune}
...
\caption{Allocation of Program Time for MPI Sweep and Prune}
...
\caption{Execution Times of Naive and Optimized GPU Algorithms}
\label{gpu_time_vs_n}
\end{figure}
